...
export function ValuesRow() {
  return (
    <Section background="hunter-green">
      ...
      <StaggerChildren className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-6 mt-12">
        {values.map((value) => {
          ...
          return (
            ...
            >
              {Icon && (
                <Icon className="w-10 h-10 text-gold-200" strokeWidth={1.5} aria-hidden="true" />
              )}
